...
This one looked complicated at first, but once I realized the word always appears in a straight line, it became much easier to understand. The idea is to loop through every letter in the grid and look for the first letter of the word. Whenever that letter matches, I check in all four directions right, left, up, and down—to see if the full word fits in that direction.

It helped to think of the grid like a crossword puzzle: you start at one letter and move in a straight line until either the letters stop matching or you find the full word. Once you find it, you can return the starting and ending positions.
