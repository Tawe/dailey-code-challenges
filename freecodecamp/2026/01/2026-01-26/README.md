...
This was a classic logic problem, but it still required paying attention to the order of conditions. The biggest thing to watch out for was handling the case where the number is divisible by both 3 and 5.

I made sure to check the combined condition first, because if I checked divisibility by 3 or 5 separately before that, the "FizzBuzz" case would never be reached. Once that was clear, the rest of the solution was very straightforward.

This problem felt more about correctness and clarity than optimization.
