...
This problem was primarily about unit conversion and comparison, not algorithmic complexity. Once both values were converted into the same unit (joules), the rest of the logic became a straightforward comparison. I liked that the problem forced me to be explicit about constants instead of hard-coding numbers inline. Converting calories and watt-hours separately made the intent of the code very clear and reduced the risk of mixing up units. Using a chained conditional expression kept the function concise while still readable, since there are only three possible outcomes. Overall, this felt like a good example of translating a real-world concept into clean, deterministic logic.
